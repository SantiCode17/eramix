...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: typography.families.subheading, ...typography.sizes.small, color: colors.text.primary },
  ...
  voteCount: { fontFamily: typography.families.bodyMedium, ...typography.sizes.small, color: colors.text.secondary },
