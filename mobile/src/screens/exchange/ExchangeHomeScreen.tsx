...
const styles = StyleSheet.create({
  ...
  statusBadge: { fontFamily: typography.families.bodyMedium, ...typography.sizes.bodySmall, color: colors.status.info },
  dateText: { fontFamily: typography.families.body, ...typography.sizes.bodySmall, color: colors.text.secondary },
